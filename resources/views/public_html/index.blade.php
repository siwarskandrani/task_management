            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto align-items-center">
                    ...
                    <li class="nav-item-auth " style="margin-left:3cm">
                        @if (Route::has('login'))
                            @auth
                                <a class="- btn btn-primary rounded mr-7" href="{{ url('/dashboard') }}" class="font-semibold">Dashboard</a>
                            @else
                                <a class="- btn btn-primary rounded mr-7" href="{{ route('login') }}" class="font-semibold">Log in</a>
                    
                                @if (Route::has('register'))
                                    <a class="- btn btn-primary rounded mr-7" href="{{ route('register') }}" class="font-semibold">Register</a>
                                @endif
                            @endauth
                        @endif
                    </li>
